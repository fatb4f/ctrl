# Deferred federation operations proposal (non-normative)

This superseded proposal is retained for research provenance only. Its history
rewriting, Gerrit, Zuul, Jujutsu-policy, replication, and archival work is
explicitly outside S0 and establishes no current repository requirement.

## Original proposal: Qualification Runtime Monorepo, Jujutsu, Gerrit, and Zuul
